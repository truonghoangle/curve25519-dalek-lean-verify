...
theorem pow2k_loop_spec (k : U32) (a : Array U64 5#usize)
  ...
  have := Nat.le_pred_of_lt a2_bound
  ...
  have a_le:= Nat.le_pred_of_lt a4_bound
  ...
  have := Nat.le_pred_of_lt a0_bound
  have aa:= mul_le_mul this this (Nat.zero_le _) (Nat.zero_le _)
  ...
  · constructor
    · intro i hi
      ...
      · simp
        ...
        · apply lt_trans h
          simp
        · rw[i62_post_1, LOW_51_BIT_MASK_spec,
          land_pow_two_sub_one_eq_mod]
          apply Nat.mod_lt
          simp
      · rename_i i
        cases i
        · simp
          suffices h : i53.val < 2 ^ 51
          · apply lt_trans h
            simp
          · rw[i53_post_1, LOW_51_BIT_MASK_spec,
            land_pow_two_sub_one_eq_mod]
            apply Nat.mod_lt
            simp
        · rename_i i
          cases i
          · simp
            suffices h : i50.val < 2 ^ 51
            · apply lt_trans h
              simp
            · rw[i50_post_1, LOW_51_BIT_MASK_spec,
              land_pow_two_sub_one_eq_mod]
              apply Nat.mod_lt
              simp
          · rename_i i
            cases i
            · simp
              suffices h : i45.val < 2 ^ 51
              · apply lt_trans h
                simp
              · rw[i45_post_1, LOW_51_BIT_MASK_spec,
                land_pow_two_sub_one_eq_mod]
                apply Nat.mod_lt
                simp
            · rename_i i
              cases i
              · simp
                rw[i60_post, LOW_51_BIT_MASK_spec,
                land_pow_two_sub_one_eq_mod,
  ...
  · intro j hj
    cases (j:ℕ)
    · simp[i62_post_1, LOW_51_BIT_MASK_spec]
      rw[(by simp: 2251799813685247= 2^ 51-1), land_pow_two_sub_one_eq_mod]
      have := Nat.mod_lt i61 (by simp: 0< 2 ^ 51)
      apply lt_trans this
      simp
    · rename_i j
      cases (j:ℕ )
      ...
      · rename_i j
        ...
        · simp_all
          rw[LOW_51_BIT_MASK_spec,
                ...
                UScalar.cast_val_eq, UScalarTy.numBits]
          simp
          have := Nat.mod_lt (c21.val) (by simp :0 < 2^ 51)
          simp at this
          apply lt_trans this
          simp
        · rename_i j
          ...
          · simp_all
            rw[LOW_51_BIT_MASK_spec,
                ...
                UScalar.cast_val_eq, UScalarTy.numBits]
            simp
            have := Nat.mod_lt (c31.val) (by simp :0 < 2^ 51)
            simp at this
            apply lt_trans this
            simp
          · rename_i j
            ...
            · simp_all
              rw[LOW_51_BIT_MASK_spec,
                ...
                UScalar.cast_val_eq, UScalarTy.numBits]
              simp
              have := Nat.mod_lt (c41.val) (by simp :0 < 2^ 51)
              simp at this
              apply lt_trans this
              simp
            · simp_all
